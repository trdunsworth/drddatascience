...
The first exam objective, according to the CompTIA document I've linked above is mathematics and statistics. It makes sense to me since math is the foundation of analytics and data science. The first subsection is to use a scenario and apply the appropriate statistical method or concept. I will fell comfortable with a lot of this since I have that background and work with statistics daily. 